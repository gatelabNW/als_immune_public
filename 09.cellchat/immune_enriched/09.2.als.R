...
als_s <- subset(s, diagnosis_general == "als")
...
cur_out_file <- glue("{cc_out_dir}/als.csv")
...
saveRDS(file = glue("{cc_out_dir}/als.rds"), cc_als)
groupSize <- as.numeric(table(cc_als@idents))
par(mfrow = c(1,2), xpd=TRUE)

pdf("/projects/b1042/Gate_Lab/projects/als-project/crispr_clean_final/09.cellchat/als_num_int.pdf",
    width = 12, height = 12)
...
pdf("/projects/b1042/Gate_Lab/projects/als-project/crispr_clean_final/09.cellchat/als_weight_int.pdf",
    width = 12, height = 12)
...
pdf("/projects/b1042/Gate_Lab/projects/als-project/crispr_clean_final/09.cellchat/als_heatmap.pdf",
    width = 12, height = 12)
netVisual_heatmap(cc_als, color.heatmap = "Reds")
dev.off()

pdf("/projects/b1042/Gate_Lab/projects/als-project/crispr_clean_final/09.cellchat/als_bubble.pdf",
    width = 12, height = 12)
