...
###
diagnosis_general_out_root <-glue("{DEG_out_dir}/degs/diagnosis_general")
...
###
c9_out_root <-glue("{DEG_out_dir}/degs/female_c9_hc")
...
###
diagnosis_out_root <-glue("{DEG_out_dir}/degs/diagnosis")
