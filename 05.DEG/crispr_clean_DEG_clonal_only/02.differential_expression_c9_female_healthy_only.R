...
# remove cell type that has less than 10 cells for one of the cell type
t <- s$diagnosis_cluster|>table()|>
  as.data.frame()|>
  dplyr::filter(Freq < 10)
cluster_skip <- sapply(t$Var1|>as.vector(), function(x){
  strsplit(x, " - ")[[1]][1]
})
