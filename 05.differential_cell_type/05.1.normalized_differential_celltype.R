...
# out_png <- glue("{output_root}/diagnosis_general_ct_lv2.png")
...
#
# out_png <- glue("{output_root}/diagnosis_ct_lv2.png")
# png(out_png, width =1920, height = 1920)
# print(p)
# dev.off()
#
# # save the calculated per sample normalized cell type data
# out_csv <- glue("{output_root}/normalized_celltype_count_lv2.csv")
