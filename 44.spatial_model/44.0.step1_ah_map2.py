...
results_folder = "/projects/b1042/Gate_Lab/projects/als-project/spatial/04.c2l_model/c2l1116_ah_map2"

MAP2_s = all_sample_sc[(all_sample_sc.obs['manual'] == 'Anterior_horns') & (all_sample_sc.obs['MAP2_90_pctile'] == 'MAP2_enriched')].copy()
