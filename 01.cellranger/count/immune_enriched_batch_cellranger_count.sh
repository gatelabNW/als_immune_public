...
fastq_dir="/projects/b1042/Gate_Lab/projects/als-project/immune_enriched_final/00.raw"
[ -d "$fastq_dir" ] && echo "Directory to fastq files exists."

# Define, make (if necessary), and navigate to output directory
output_dir="/projects/b1042/Gate_Lab/projects/als-project/immune_enriched_final/01.cellranger_count"
...
do
    ...
    sbatch cellranger_count.sh "$id" "$sample_dir" "$sample" "$cell_num" "$output_dir"
