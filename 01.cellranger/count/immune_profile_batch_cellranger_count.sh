...
output_dir="/projects/b1042/Gate_Lab/projects/als-project/scrna_original_final/01.cellranger_count"
...
while IFS=  read -r -d $'\0'; do
    sample_arr+=("$REPLY")
done < <(find "$fastq_dir" -maxdepth 1 -mindepth 1  -name "*GEX*" -type d -print0)
