...
cur_sample="E4"
in_FQ_dir="${out_root}/01.preprocess/${cur_sample}"
in_CB_dir="${out_root}/02.CB_collapse/${cur_sample}"
...
out_dir="${out_root}/03.CB_alignment_no_consensus/${cur_sample}"
temp_out_dir="${out_root}/03.CB_alignment_no_consensus/${cur_sample}/tmp"
