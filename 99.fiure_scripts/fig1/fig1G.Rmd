...
# title_id <- "sALS_.vs._healthy_control"

input_file_root <- "/projects/b1042/Gate_Lab/projects/als-project/crispr_clean_final/05.DEG_717_filter/degs/diagnosis_general/SCT/age_sex"
title_id <- "all_ALS_.vs._healthy_control"
...
out_file <- glue("{out_dir_root}/Fig1G__{title_id}.pdf")
out_file_broad <- glue("{out_dir_root}/Fig1G__{title_id}_broad.pdf")
deg_threshold<-0.01
fc_threshold<-0.585
