...
# DEG_out_dir <- glue("{out_dir_root}/04.downstream_analysis/DE_random_effect_manual_1207_no_border")
# cluster_col <- "manual_3"


#
DEG_out_dir <- glue("{out_dir_root}/04.downstream_analysis/DE_random_effect_manual_1207_with_border")
cluster_col <- "manual"



input_data_dir <- glue("{out_dir_root}/03.seurat_process")
out_data_dir <- glue("{DEG_out_dir}/sALS_hc/data")
out_plot_dir <- glue("{DEG_out_dir}/sALS_hc/plot")
