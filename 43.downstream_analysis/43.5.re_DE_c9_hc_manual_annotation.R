...
# DEG_out_dir <- glue("{out_dir_root}/04.downstream_analysis/DE_random_effect_manual_1211_no_border")
# cluster_col <- "manual_3"



DEG_out_dir <- glue("{out_dir_root}/04.downstream_analysis/DE_random_effect_manual_1211_with_border")
cluster_col <- "manual"
