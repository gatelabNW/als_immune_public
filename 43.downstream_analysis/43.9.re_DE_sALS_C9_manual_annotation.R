...
DEG_out_dir <- glue("{out_dir_root}/04.downstream_analysis/DE_random_effect_manual_1115")
input_data_dir <- glue("{out_dir_root}/03.seurat_process")
out_data_dir <- glue("{DEG_out_dir}/sALS_C9/data")
out_plot_dir <- glue("{DEG_out_dir}/sALS_C9/plot")
...
comparison <- "sALS_vs._C9"
cluster_col <- "manual_3"
p_thresh <- 0.05
fc_thresh <- log2(1.5)
condition_col <- "condition"

s <- readRDS(glue("{input_data_dir}/data/all_samples_seurat_1107.rds"))
