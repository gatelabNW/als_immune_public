...
#TODO: change comparison name when applicable
...
# set idents
# TODO: Set ident1 to sALS or C9orf72 for different comparison
ident.1 <- "C9orf72"
ident.2 <- "Control"

# weird issue with joining layers on this object causing prepsctfindermarker to not work
# manually tagging it to the original object
...
cur_enriched_spot_ids <- dplyr::filter(s@meta.data, get(cluster) == 1)|>
  rownames()
