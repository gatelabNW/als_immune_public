...
seurat <- FindClusters(seurat, resolution = 0.5, cluster.name = "mnn_clusters")
seurat <- RunUMAP(seurat, reduction = "integrated.mnn", dims = 1:30, reduction.name = "umap.mnn")

saveRDS(seurat, glue("{seurat_output_dir}/seurat_MNN_04_01.rds"))
